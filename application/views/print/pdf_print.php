...
<section class="sheet" style="padding:50px 70px;">
	<div id="container">
		...
		<div class='wrapper-full'>
			<div class='wrapper-content'>
				<div class="logo" style="text-align: center; font-weight: bold;">
					...
					<div style="font-size: 13px;">Nomor: <?php echo $submit['nomor_laporan']; ?><!-- STLK / 9380 / XI / YAN.2.5 / 2018 / SPKT / RESTA SDA --></div>
				</div>
				<div class="" style="margin-top: 15px; font-size: 13px; text-align: justify;">
					...
					<?php endforeach; ?></ul>
					<p><?php echo $submit['lokasi_hilang']; ?></p>
		...
		<div class="wrapper-right">
			<div class='wrapper-content' style="font-weight: bold; text-align: center">
				<div class="pelapor"><?php echo $submit['petugas_jabatan']; ?></div>
				<div class="pelapor_name" style="margin-top: 100px;">
					<span style="text-decoration: underline;"><?php echo $submit['petugas_nama']; ?></span>
					<br>
					<span><?php echo $submit['petugas_nomor']; ?></span>
				</div>
			</div>
		</div>
