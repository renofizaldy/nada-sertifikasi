require.config({
	paths: {
		...
		'datatables': 'plugins/datatables/DataTables-1.10.18/js/dataTables.bootstrap4.min',
		'select2': 'plugins/select2/select2.min',
		'summernote': 'plugins/summernote/summernote-bs4.min',
		'datepicker': 'plugins/air-datepicker/js/datepicker.min',
		'datepicker_eng': 'plugins/air-datepicker/js/datepicker.en',
